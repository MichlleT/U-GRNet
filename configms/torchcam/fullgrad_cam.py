import numpy as np
import torch
from configms.torchcam.base_cam import BaseCAM
from configms.torchcam.utils.find_layers import find_layer_predicate_recursive
from configms.torchcam.utils.svd_on_activations import get_2d_projection
from configms.torchcam.utils.image import scale_accross_batch_and_channels, scale_cam_image
